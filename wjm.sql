...
MySQL - 5.5.27 : Database - itcaststore
*********************************************************************
*/
...
insert  into `admin`(`id`,`username`,`PASSWORD`,`email`,`telephone`,`role`) values (1,'admin','123456','wjm@qq.com','17339821235',1),(2,'wjm','654321','1021347250@qq.com','17339821235',2),(4,'tjf','123456','1021347250@qq.com','13609331805',3);
...
insert  into `class`(`id`,`name`,`classfication`,`price`,`teacher`,`text`,`time`) values (0,'','','','','',''),(0,'','','','','',''),(NULL,NULL,NULL,NULL,NULL,'',''),(NULL,'python开发21天入门','music','2222','陈永教授','123','2021-07-14');
...
CREATE TABLE `school` (
  ...
  `telephone` varchar(20) DEFAULT NULL,
  `astrict` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `school` */

insert  into `school`(`id`,`school_name`,`people`,`telephone`,`astrict`) values (1,'兰州交通大学','王俊铭','13014127044','300'),(2,'清华大学','温博','17339821235','20'),(3,'北京大学','武壮壮','13609331805','300'),(NULL,'南京大学','孟佩云','13609331805','12'),(NULL,'南京大学','孟佩云','13609331805','12');
